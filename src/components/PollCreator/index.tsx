    ...
    return (
        <section>
            ...
            <div className='optionList'>
                ...
                <OptionInput placeholder='Type an answer' value={optionText} onChange={setOptionText} disabled={disableAddition} button={{ content: 'Add', disabled: disableAddition, onClick: handleAddOption }} />
            </div>
            <div>
